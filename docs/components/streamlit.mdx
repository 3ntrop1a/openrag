...
<Info>
The admin panel (Streamlit, port 8502) remains available in Docker for document management. The Next.js frontend is the primary user-facing chat interface.
</Info>
